...
/*********************************************************************************************************
  内部宏定义
*********************************************************************************************************/
#define TPS_TRANS_ARRSIZE           0x1000                              /* 事务头数组大小               */
#define TPS_TRANS_MAXAREA           0x300                               /* 最大事务区间数量             */
#define TPS_TRANS_TRIGGERREA        0x100                               /* 触发事务提交的区间数量       */
#define TPS_TRANS_REV_DATASEC       1024                                /* 保留的事务数据区空间大小     */
