...
#define LX_FMT      "0x%08x"
    ...
    if (iFd >= 0) {
        ...
        fdprintf(iFd, "R4(REGS0)  = "LX_FMT"\n", pregctx->REG_ulReg[4]);
        fdprintf(iFd, "R5(REGS1)  = "LX_FMT"\n", pregctx->REG_ulReg[5]);
        fdprintf(iFd, "R6(REGS2)  = "LX_FMT"\n", pregctx->REG_ulReg[6]);
        fdprintf(iFd, "R7(REGS3)  = "LX_FMT"\n", pregctx->REG_ulReg[7]);
        fdprintf(iFd, "R8(FP)     = "LX_FMT"\n", pregctx->REG_ulReg[8]);
        fdprintf(iFd, "R9(REGS5)  = "LX_FMT"\n", pregctx->REG_ulReg[9]);
        fdprintf(iFd, "R10(REGS6) = "LX_FMT"\n", pregctx->REG_ulReg[10]);
        fdprintf(iFd, "R11(REGS7) = "LX_FMT"\n", pregctx->REG_ulReg[11]);
        fdprintf(iFd, "R12(REGS8) = "LX_FMT"\n", pregctx->REG_ulReg[12]);
        fdprintf(iFd, "R13(REGS9) = "LX_FMT"\n", pregctx->REG_ulReg[13]);
        fdprintf(iFd, "R14(SP)    = "LX_FMT"\n", pregctx->REG_ulReg[14]);
#else
        fdprintf(iFd, "R0(SP)     = "LX_FMT"\n", pregctx->REG_ulReg[0]);
        fdprintf(iFd, "R1(REGS9)  = "LX_FMT"\n", pregctx->REG_ulReg[1]);
        fdprintf(iFd, "R2(A0)     = "LX_FMT"\n", pregctx->REG_ulReg[2]);
        fdprintf(iFd, "R3(A1)     = "LX_FMT"\n", pregctx->REG_ulReg[3]);
        fdprintf(iFd, "R4(A2)     = "LX_FMT"\n", pregctx->REG_ulReg[4]);
        fdprintf(iFd, "R5(A3)     = "LX_FMT"\n", pregctx->REG_ulReg[5]);
        fdprintf(iFd, "R6(REGS0)  = "LX_FMT"\n", pregctx->REG_ulReg[6]);
        fdprintf(iFd, "R7(REGS1)  = "LX_FMT"\n", pregctx->REG_ulReg[7]);
        fdprintf(iFd, "R8(REGS2)  = "LX_FMT"\n", pregctx->REG_ulReg[8]);
        fdprintf(iFd, "R9(REGS3)  = "LX_FMT"\n", pregctx->REG_ulReg[9]);
        fdprintf(iFd, "R10(REGS4) = "LX_FMT"\n", pregctx->REG_ulReg[10]);
        fdprintf(iFd, "R11(REGS5) = "LX_FMT"\n", pregctx->REG_ulReg[11]);
        fdprintf(iFd, "R12(REGS6) = "LX_FMT"\n", pregctx->REG_ulReg[12]);
        fdprintf(iFd, "R13(REGS7) = "LX_FMT"\n", pregctx->REG_ulReg[13]);
        fdprintf(iFd, "R14(REGS8) = "LX_FMT"\n", pregctx->REG_ulReg[14]);
#endif                                                                  /*  __CSKYABIV2__               */
...
#define LX_FMT      "0x%08x"
        ...
        stOft = bnprintf(pvBuffer, stSize, stOft, "R4(REGS0)  = "LX_FMT"\n", pregctx->REG_ulReg[4]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R5(REGS1)  = "LX_FMT"\n", pregctx->REG_ulReg[5]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R6(REGS2)  = "LX_FMT"\n", pregctx->REG_ulReg[6]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R7(REGS3)  = "LX_FMT"\n", pregctx->REG_ulReg[7]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R8(FP)     = "LX_FMT"\n", pregctx->REG_ulReg[8]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R9(REGS5)  = "LX_FMT"\n", pregctx->REG_ulReg[9]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R10(REGS6) = "LX_FMT"\n", pregctx->REG_ulReg[10]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R11(REGS7) = "LX_FMT"\n", pregctx->REG_ulReg[11]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R12(REGS8) = "LX_FMT"\n", pregctx->REG_ulReg[12]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R13(REGS9) = "LX_FMT"\n", pregctx->REG_ulReg[13]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R14(SP)    = "LX_FMT"\n", pregctx->REG_ulReg[14]);
#else
        stOft = bnprintf(pvBuffer, stSize, stOft, "R0(SP)     = "LX_FMT"\n", pregctx->REG_ulReg[0]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R1(REGS9)  = "LX_FMT"\n", pregctx->REG_ulReg[1]);
        ...
        stOft = bnprintf(pvBuffer, stSize, stOft, "R6(REGS0)  = "LX_FMT"\n", pregctx->REG_ulReg[6]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R7(REGS1)  = "LX_FMT"\n", pregctx->REG_ulReg[7]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R8(REGS2)  = "LX_FMT"\n", pregctx->REG_ulReg[8]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R9(REGS3)  = "LX_FMT"\n", pregctx->REG_ulReg[9]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R10(REGS4) = "LX_FMT"\n", pregctx->REG_ulReg[10]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R11(REGS5) = "LX_FMT"\n", pregctx->REG_ulReg[11]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R12(REGS6) = "LX_FMT"\n", pregctx->REG_ulReg[12]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R13(REGS7) = "LX_FMT"\n", pregctx->REG_ulReg[13]);
        stOft = bnprintf(pvBuffer, stSize, stOft, "R14(REGS8) = "LX_FMT"\n", pregctx->REG_ulReg[14]);
#endif                                                                  /*  __CSKYABIV2__               */
...
#define LX_FMT      "0x%08x"
        ...
        _PrintFormat("R4(REGS0)  = "LX_FMT"\r\n", pregctx->REG_ulReg[4]);
        _PrintFormat("R5(REGS1)  = "LX_FMT"\r\n", pregctx->REG_ulReg[5]);
        _PrintFormat("R6(REGS2)  = "LX_FMT"\r\n", pregctx->REG_ulReg[6]);
        _PrintFormat("R7(REGS3)  = "LX_FMT"\r\n", pregctx->REG_ulReg[7]);
        _PrintFormat("R8(FP)     = "LX_FMT"\r\n", pregctx->REG_ulReg[8]);
        _PrintFormat("R9(REGS5)  = "LX_FMT"\r\n", pregctx->REG_ulReg[9]);
        _PrintFormat("R10(REGS6) = "LX_FMT"\r\n", pregctx->REG_ulReg[10]);
        _PrintFormat("R11(REGS7) = "LX_FMT"\r\n", pregctx->REG_ulReg[11]);
        _PrintFormat("R12(REGS8) = "LX_FMT"\r\n", pregctx->REG_ulReg[12]);
        _PrintFormat("R13(REGS9) = "LX_FMT"\r\n", pregctx->REG_ulReg[13]);
        _PrintFormat("R14(SP)    = "LX_FMT"\r\n", pregctx->REG_ulReg[14]);
#else
        _PrintFormat("R0(SP)     = "LX_FMT"\r\n", pregctx->REG_ulReg[0]);
        _PrintFormat("R1(REGS9)  = "LX_FMT"\r\n", pregctx->REG_ulReg[1]);
        _PrintFormat("R2(A0)     = "LX_FMT"\r\n", pregctx->REG_ulReg[2]);
        _PrintFormat("R3(A1)     = "LX_FMT"\r\n", pregctx->REG_ulReg[3]);
        _PrintFormat("R4(A2)     = "LX_FMT"\r\n", pregctx->REG_ulReg[4]);
        _PrintFormat("R5(A3)     = "LX_FMT"\r\n", pregctx->REG_ulReg[5]);
        _PrintFormat("R6(REGS0)  = "LX_FMT"\r\n", pregctx->REG_ulReg[6]);
        _PrintFormat("R7(REGS1)  = "LX_FMT"\r\n", pregctx->REG_ulReg[7]);
        _PrintFormat("R8(REGS2)  = "LX_FMT"\r\n", pregctx->REG_ulReg[8]);
        _PrintFormat("R9(REGS3)  = "LX_FMT"\r\n", pregctx->REG_ulReg[9]);
        _PrintFormat("R10(REGS4) = "LX_FMT"\r\n", pregctx->REG_ulReg[10]);
        _PrintFormat("R11(REGS5) = "LX_FMT"\r\n", pregctx->REG_ulReg[11]);
        _PrintFormat("R12(REGS6) = "LX_FMT"\r\n", pregctx->REG_ulReg[12]);
        _PrintFormat("R13(REGS7) = "LX_FMT"\r\n", pregctx->REG_ulReg[13]);
        _PrintFormat("R14(REGS8) = "LX_FMT"\r\n", pregctx->REG_ulReg[14]);
#endif                                                                  /*  __CSKYABIV2__               */
