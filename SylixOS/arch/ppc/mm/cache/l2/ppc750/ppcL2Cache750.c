                         ...
                         CPCHAR       pcMachineName)
{
    ...
    if (_G_l2Config.CFG_bPresent) {
         ...
         */
        _G_pucL2CacheReadBuffer = __KHEAP_ALLOC_ALIGN(_G_l2Config.CFG_stSize * 3 / 2,
        ...
        if (lib_strcmp(pcMachineName, PPC_MACHINE_750) == 0) {
            ...
            bHardwareFlush          = LW_FALSE;

        } else {
            _G_l2Config.CFG_uiL2CR |= PPC7450_L2CR_DO;
            bHardwareFlush          = LW_TRUE;
        }
        ...
        pl2cdrv->L2CD_pfuncFlushAll      = bHardwareFlush ?
                                           ppc750L2CacheFlushAllHW : __ppc750L2CacheFlushAllSW;
