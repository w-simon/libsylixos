...
#define __SYLIXOS_VERSION               __SYLIXOS_MAKEVER(1, 3, 5)
#define __SYLIXOS_VERPATCH              0x3                             /* 小于 0x10000 为测试版        */
                                                                        /* 等于 0x10000 为正式发布版本  */
#define __SYLIXOS_VERSTR                "1.3.5-rc3"
#define __SYLIXOS_RELSTR                "LongYuan(b)"
