...
/*********************************************************************************************************
 ...
 NOTICE:
 The ... arguments is: mode_t mode, unsigned int total_size, unsigned int atomic_size.
 If (flags & O_CREAT) You must add 'mode' argument.
 If ((flags & O_CREAT) && (flags & BMSGFD_SETBUFFER)) You must add 'mode' 'size' 'atomic_size' arguments.
