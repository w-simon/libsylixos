...
#define SDHOST_EXTOPT_CACHE_WP_SET          6
#define SDHOST_EXTOPT_CACHE_WP_GET          7

#define SDHOST_EXTOPT_CACHE_COHERENCE_SET   8
#define SDHOST_EXTOPT_CACHE_COHERENCE_GET   9
